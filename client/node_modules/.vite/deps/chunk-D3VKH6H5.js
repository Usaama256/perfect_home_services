...
import {
  _inheritsLoose
} from "./chunk-ILY7NLSP.js";
import {
  _assertThisInitialized
} from "./chunk-BUFX4GDD.js";
import {
  require_react_dom
...
function decomposeColor(color2) {
  ...
  if (["rgb", "rgba", "hsl", "hsla"].indexOf(type) === -1) {
    throw new Error(import_process.default.env.NODE_ENV !== "production" ? "Material-UI: Unsupported `".concat(color2, "` color.\nWe support the following formats: #nnn, #nnnnnn, rgb(), rgba(), hsl(), hsla().") : formatMuiErrorMessage(3, color2));
  }
...
function createPalette(palette2) {
  ...
  var augmentColor = function augmentColor2(color2) {
    ...
    if (!color2.main) {
      throw new Error(import_process.default.env.NODE_ENV !== "production" ? "Material-UI: The color provided to augmentColor(color) is invalid.\nThe color object needs to have a `main` property or a `".concat(mainShade, "` property.") : formatMuiErrorMessage(4, mainShade));
    }
...
var responsivePropType = import_process.default.env.NODE_ENV !== "production" ? import_prop_types3.default.oneOfType([import_prop_types3.default.number, import_prop_types3.default.string, import_prop_types3.default.object, import_prop_types3.default.array]) : {};
...
function style(options) {
  ...
  fn.propTypes = import_process.default.env.NODE_ENV !== "production" ? _defineProperty({}, prop, responsivePropType_default) : {};
  fn.filterProps = [prop];
  return fn;
}
...
function compose() {
  ...
  fn.propTypes = import_process.default.env.NODE_ENV !== "production" ? styles3.reduce(function(acc, style2) {
...
function styleFunctionSx(styleFunction) {
  ...
  newStyleFunction.propTypes = import_process.default.env.NODE_ENV !== "production" ? _extends({}, styleFunction.propTypes, {
...
spacing.propTypes = import_process.default.env.NODE_ENV !== "production" ? spacingKeys.reduce(function(obj, key) {
...
function createSpacing() {
  ...
  Object.defineProperty(spacing2, "unit", {
    get: function get2() {
      if (import_process.default.env.NODE_ENV !== "production") {
        if (!warnOnce || import_process.default.env.NODE_ENV === "test") {
...
import_process.default.env.NODE_ENV !== "production" ? StylesProvider.propTypes = {
  /**
   * Your component tree.
   */
...
if (import_process.default.env.NODE_ENV !== "production") {
  import_process.default.env.NODE_ENV !== "production" ? StylesProvider.propTypes = exactProp(StylesProvider.propTypes) : void 0;
}
...
function styled(Component) {
  var componentCreator = function componentCreator2(style2) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && Component === void 0) {
    ...
    import_process.default.env.NODE_ENV !== "production" ? StyledComponent.propTypes = _extends({
      /**
...
var withStyles = function withStyles2(stylesOrCreator) {
  ...
  return function(Component) {
    ...
    import_process.default.env.NODE_ENV !== "production" ? WithStyles.propTypes = {
      /**
...
function withThemeCreator() {
  ...
  var withTheme2 = function withTheme3(Component) {
    ...
    import_process.default.env.NODE_ENV !== "production" ? WithTheme.propTypes = {
      /**
       * Use that prop to pass a ref to the decorated component.
       * @deprecated
       */
...
// node_modules/@material-ui/styles/esm/index.js
if (import_process.default.env.NODE_ENV !== "production" && import_process.default.env.NODE_ENV !== "test" && typeof window !== "undefined") {
...
function capitalize(string) {
  if (typeof string !== "string") {
    throw new Error(import_process.default.env.NODE_ENV !== "production" ? "Material-UI: capitalize(string) expects a string argument." : formatMuiErrorMessage(7));
  }
...
@material-ui/styles/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-D3VKH6H5.js.map
